...
public class ModLanguageProvider_en_us extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add("item." + FoodMod.MODID + "." + ModItems.LEBRON_MUSIC_DISC.get() + ".desc", "TinnedFoil906 - James");
        this.add(ModItems.LEBRON_MUSIC_DISC_REMIX.get(), "LeBron James Music Disc");
        this.add("item." + FoodMod.MODID + "." + ModItems.LEBRON_MUSIC_DISC_REMIX.get() + ".desc", "TinnedFoil906 - James II");
        this.add(ModItems.LEBRON_MUSIC_DISC_SUNSHINE.get(), "LeBron James Music Disc");
        this.add("item." + FoodMod.MODID + "." + ModItems.LEBRON_MUSIC_DISC_SUNSHINE.get() + ".desc", "Christina Perri - You Are My Sunshine");
        ...
        this.add("sounds.morefood.lebron_block_break", "LeBron James Block Break");
        this.add("sounds.morefood.lebron_block_step", "LeBron James Block Step");
        this.add("sounds.morefood.lebron_block_place", "LeBron James Block Place");
        this.add("sounds.morefood.lebron_block_hit", "LeBron James Block Hit");
        this.add("sounds.morefood.lebron_block_fall", "LeBron James Block Fall");
    }
