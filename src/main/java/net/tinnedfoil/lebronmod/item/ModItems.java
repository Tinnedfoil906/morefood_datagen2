...
import net.tinnedfoil.lebronmod.item.custom.ExtraBurntLebronJames;
import net.tinnedfoil.lebronmod.item.custom.FlintAndSteelAndLebron;
import net.tinnedfoil.lebronmod.item.custom.HoneyDippedLebron;
...
public class ModItems
{
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, LebronMod.MODID);
