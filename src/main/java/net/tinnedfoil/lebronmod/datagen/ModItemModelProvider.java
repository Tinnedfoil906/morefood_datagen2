...
public class ModItemModelProvider extends ItemModelProvider {
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, LebronMod.MODID, existingFileHelper);
    }
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                .texture("layer0", new ResourceLocation(LebronMod.MODID,"item/" + item.getId().getPath()));
    }
    ...
    private ItemModelBuilder onFireItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                .texture("layer1", new ResourceLocation(LebronMod.MODID,"item/" + item.getId().getPath()))
    ...
    public void evenSimplerBlockItem(RegistryObject<Block> block) {
        this.withExistingParent(LebronMod.MODID + ":" + ForgeRegistries.BLOCKS.getKey(block.get()).getPath(),
    ...
    public void fenceItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        ...
        this.withExistingParent(blockPath, mcLoc("block/fence_inventory"))
                .texture("texture", new ResourceLocation(LebronMod.MODID, "block/" + baseBlockPath));
    }
    ...
    public void wallItem(RegistryObject<Block> block, RegistryObject<Block> baseBlock) {
        ...
        this.withExistingParent(blockPath, mcLoc("block/wall_inventory"))
                .texture("wall", new ResourceLocation(LebronMod.MODID, "block/" + baseBlockPath));
    }

    private ItemModelBuilder simpleBlockItem(RegistryObject<Block> item) {
        return withExistingParent(item.getId().getPath(),
                new ResourceLocation("item/generated")).texture("layer0",
                new ResourceLocation(LebronMod.MODID,"item/" + item.getId().getPath()));
    }
