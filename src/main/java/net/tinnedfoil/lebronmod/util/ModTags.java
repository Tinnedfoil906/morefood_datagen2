package net.tinnedfoil.lebronmod.util;
...
public class ModTags
{
    public static class Blocks
    {
        ...
        {
            return BlockTags.create(new ResourceLocation(LebronMod.MODID, name));
        }
    }
    ...
    public static class Items
    {
        ...
        {
            return ItemTags.create(new ResourceLocation(LebronMod.MODID, name));
        }
    }
}
